...
/**
 * Servlet implementation class AddCusServlet
 */
@WebServlet(urlPatterns = {"/AddCusServlet"})
public class AddCusServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(hasError) {
			...
			RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/WEB-INF/views/addCus.jsp");
